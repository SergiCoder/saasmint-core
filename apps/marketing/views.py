...
from apps.marketing.email import _redact_email
...
class MarketingInquiryView(APIView):
    ...
    def post(self, request: Request) -> Response:
        ...
        # Read at request time so deploy-time env changes take effect without a code restart.
        to_address = os.environ.get("MARKETING_INQUIRIES_TO", "").strip()
        if not to_address:
